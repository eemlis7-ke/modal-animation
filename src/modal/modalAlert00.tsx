...
export const ModalAlert00: React.FC<Props> = memo((props) => {
  ...
  return (
    <>
      <Modal
        ...
        className="is-modal-alert"
        // overlayOpacity={0.55}
        // overlayBlur={3}
        // closeOnClickOutside={false}
      >
        {/* Modal content */}
        <Text className='modal-boday'>テキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキスト</Text>
      ...
      <Group position="center">
        <Button onClick={() => setOpened(true)} color="teal">{props.modalButtonLabel}</Button>
      </Group>
    </>
  );
})
